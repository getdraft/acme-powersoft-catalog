...
| Repository | Contents |
|---|---|
| [getdraft/acme-powersoft-catalog](https://github.com/getdraft/acme-powersoft-catalog) | Vendored DRAFT framework, `catalog/` (6 active RequirementGroups, 18 shared-service objects, 6 teams' product-specific catalog objects, 6 SoftwareDeploymentPatterns, 15 capability-implementation `object_patch` overlays), `.draft/workspace.yaml` (business taxonomy + teams vocabulary declared), `teams/*/ONBOARDING.md`, generated `docs/` browser (144 objects), this report |
