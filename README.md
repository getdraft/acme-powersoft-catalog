# Acme PowerSoft DRAFT Workspace

This repository is the DRAFT architecture workspace for Acme PowerSoft. It
...
```text
I want a Draftsman session for Acme PowerSoft DRAFT Workspace.

Use the DRAFT workspace repository getdraft/acme-powersoft-catalog.
...
- `catalog/` contains Acme PowerSoft architecture inventory.
- `configurations/` contains Acme PowerSoft capabilities, RequirementGroups,
